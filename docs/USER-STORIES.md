...
### US-39 · Wissensgraph · P2
Als Nutzer möchte ich das Wissen als Graph sehen wie in Obsidian: Seiten und Vorschläge als Knoten,
Domänen und Rollen als Hubs, explizite Links und inhaltliche Ähnlichkeit als Kanten, mit Zoom, Drag,
Suche und Klick zur Seite. Der Graph zeigt nur, was ich lesen darf; beim Rollenwechsel ändert er sich.
Tests: `test_graph` (26, davon 7 Security: kein Finance-Knoten für Mitarbeiter, Gast nur öffentlich,
Wikilink auf unsichtbares Ziel erzeugt keine Kante, jede Kante hat existierende Endpunkte).
Manuell: `/graph` als Gast (5 Knoten) → Rolle CFO wählen → 15 Knoten mit Hub FINANCE.
