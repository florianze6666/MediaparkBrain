...
start_fy: 2026
go_live_fy: 2027
project_manager: "Digital Product Lead"
...
**Metriken:** Reduktion der Zeit zur Erstellung der Einkaufsliste; Reduktion der Wartezeit
an der Kasse; Vermeidung von Rechnungsdrucken.
...
| Kennzahl | Wert |
|---|---:|
| Total costs (alle Jahre) | 1.536.975 € |
| Total benefits (alle Jahre) | 6.370.000 € |
| EBIT (alle Jahre) | 4.833.025 € |
| Discounted EVA (alle Jahre) | 2.524.205 € |
| ROI (alle Jahre) | 3,16 |
| Payback Period | 1 Jahr 8 Monate (≈ 20 Monate) |
| Tax Rate | 26,9 % |
| WACC | 5,8 % |
...
|---|---:|---:|---:|
| 2026 | 115.000 | 0 | -115.000 |
| 2027 | 170.000 | 530.000 | 360.000 |
| 2028 | 214.136 | 730.000 | 515.864 |
| 2029 | 84.136 | 730.000 | 645.864 |
| 2030 | 224.136 | 730.000 | 505.864 |
| 2031 | 219.568 | 730.000 | 510.432 |
| 2032 | 215.000 | 730.000 | 515.000 |
| 2033 | 145.000 | 730.000 | 585.000 |
...
|---|---:|---|
| SC 70 - Project Capitalizable (intern) | 250.000 | Internal product, UX and architecture effort |
| SC 70 - Project Capitalizable (extern) | 400.000 | External mobile app development and system integration |
| SC 90 - Software Licenses (intern) | 50.000 | Software licences / analytics tooling |
| Local IT/IM Investments (extern) | 100.000 | Local rollout infrastructure and devices |
| SC 10 - Project Non Capitalizable (intern) | 50.000 | Internal rollout, testing and change effort |
| SC 10 - Project Non Capitalizable (extern) | 50.000 | External localisation, testing and launch support |

**Recurrent (ab 2027, p.a.):**

| Position | Betrag | Beschreibung |
|---|---:|---|
| SC 30 - Maint. and Support (intern) | 25.000 | Internal product support and operations |
...
- 300.000 € — Incremental sales from higher shopping frequency (steigend auf 300k ab 2028)
- 150.000 € — Incremental sales from personalised customer communication (steigend auf 150k ab 2028)

**Cost Savings (ab 2027, p.a.):**

- 100.000 € — Reduced checkout and customer-service handling effort
- 80.000 € — Reduced invoice printing and paper handling
- 100.000 € — Efficiency from digital shopping-list preparation and self-service

**Nicht-quantitative Nutzen:** Höhere Kundenzufriedenheit und -bindung; einheitlicher
